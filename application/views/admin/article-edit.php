                ...
                <div class="ui segments">
                    ...
                    <div class="ui clearing segment">
                        ...
                        <div class="ui form">
                            <div class="field">
                                <label>Judul</label>
                                <input type="text" placeholder="Judul" name="judul" value="<?php echo $article['JUDUL'] ?>">
                            </div>
                            <div class="field">
                                <label>Konten</label>
                                <textarea class="trumbowygeditor" name="konten"><?php echo $article['KONTEN']->load() ?></textarea>
                            </div>
